...
This branch is for Minecraft 1.17.1. Version `1.0.1.117011` requires Forge
37.1.1 or a compatible Forge 37 build and Java 16.
...
- Use the standard Minecraft 1.17 waterlogging behaviour on slabs.
...
- [Release notes](docs/RELEASE-1.0.1.117011.md)
