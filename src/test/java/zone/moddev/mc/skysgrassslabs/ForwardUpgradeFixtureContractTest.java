...
public class ForwardUpgradeFixtureContractTest {
    ...
    private static final Fixture[] FIXTURES = {
            ...
            new Fixture("1.17.1", "1.0.1.117011",
                    ...
                    true),
            new Fixture("1.18.2", "1.1.0.118021",
                    "AEAAD4453D0C32DF515605D68BF2E0DCA8CCA16B9964C52D6D5B8B82EC1D77F5",
                    "BA0FE456768BD3DBE7974714F255100C9D40C69DC16FCA59227C8F9C9ACEF1FB", 11,
                    true),
            new Fixture("1.19.4", "1.1.0.119041",
                    "C2CAE48BEDE24EF2ED7F06987C22A007404E0FA44FD43BF0AA4EE05690E9C798",
                    "8F6E6B505F830D2785A76A2982A4AEA9B4CA82431150E73AB87388BA42BAA138", 11,
                    true),
            new Fixture("1.20.1", "1.1.0.120011",
                    "D294E4A0E6BE42A5260B90A673CF31BDF390752CAAF77F7ED0349105F44F9C48",
                    "92F286CF93DDF8F67C9CBF84012937894EE5DC064CE7C870C8010818A9ED7016", 11,
                    true),
            new Fixture("1.20.6", "1.1.0.120061",
                    "16E70B7449AE601348947306982E01C363F32B76010E177885507BB00B76AC9B",
                    "580D359BD3D37184120D75C78BDF84523EDAF1C79AC517D4587FFCB1CD866D79", 11,
                    true),
            new Fixture("1.21.1", "1.1.0.121011",
                    "11E0F3DA93113FACDFA744C7047F416A9284B94CBDBC29C10AC6C7C952645C5E",
                    "9A5B5A3DEA82694C2519952728B08D11CB8928B558C2A047C0B8F5FDB85EB46B", 11,
                    true),
    ...
    public void fixturesContainOnlyRequiredWorldFiles() throws Exception {
        ...
        for (Fixture fixture : FIXTURES) {
            Set<String> expected;
            if (fixture.namespacedWorldData) {
    ...
    private static final class Fixture {
        ...
        private final boolean namespacedWorldData;
        ...
        private Fixture(String minecraftVersion, String modVersion, String fixtureSha256,
            ...
            this.namespacedWorldData = namespacedWorldData;
