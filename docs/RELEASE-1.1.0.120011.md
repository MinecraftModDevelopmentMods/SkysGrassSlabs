# Sky's Grass Slabs 1.1.0 for Minecraft 1.20.1
...
turf, while suitable steps in newly generated Overworld terrain can receive a
grass slab for a smoother slope.
...
- Optional recovery for supported blocks and items from older grass slab mods.
...
world, then read [the world upgrade guide](WORLD-UPGRADES.md).

Requires Minecraft 1.20.1, Forge 47.4.10 or a compatible Forge 47 build, and
Java 17.
